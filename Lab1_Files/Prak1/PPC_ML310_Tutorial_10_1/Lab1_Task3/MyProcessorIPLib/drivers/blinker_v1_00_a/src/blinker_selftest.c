//////////////////////////////////////////////////////////////////////////////
// Filename:          H:\HSC\1\Lab1_Files\Prak1\PPC_ML310_Tutorial_10_1\Lab1_Task3\MyProcessorIPLib/drivers/blinker_v1_00_a/src/blinker_selftest.c
// Version:           1.00.a
// Description:       Contains a diagnostic self-test function for the blinker driver
...
XStatus BLINKER_SelfTest(void * baseaddr_p)
{
  ...
  BLINKER_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = BLINKER_mReadSlaveReg0(baseaddr, 0);
