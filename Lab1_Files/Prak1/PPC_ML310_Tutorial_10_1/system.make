...
# C:\Temp\Prak1\PPC_ML310_Tutorial_10_1\system.mhs
# The software specification of the system is in file :
# C:\Temp\Prak1\PPC_ML310_Tutorial_10_1\system.mss
...
Blinker_program: $(BLINKER_OUTPUT) 

$(BLINKER_OUTPUT) : $(BLINKER_SOURCES) $(BLINKER_HEADERS) $(BLINKER_LINKER_SCRIPT) \
                    $(LIBRARIES) __xps/blinker_compiler.opt
	@mkdir -p $(BLINKER_OUTPUT_DIR) 
	$(BLINKER_CC) $(BLINKER_CC_OPT) $(BLINKER_SOURCES) -o $(BLINKER_OUTPUT) \
	$(BLINKER_OTHER_CC_FLAGS) $(BLINKER_INCLUDES) $(BLINKER_LIBPATH) \
	$(BLINKER_CFLAGS) $(BLINKER_LFLAGS) 
	$(BLINKER_CC_SIZE) $(BLINKER_OUTPUT) 
	@echo ""

Blinker_programclean:
	rm -f $(BLINKER_OUTPUT) 
...
$(SYSTEM_ACE): $(DOWNLOAD_BIT) $(TESTAPP_MEMORY_OUTPUT) $(BLINKER_OUTPUT) 
	@echo "*********************************************"
	@echo "Creating system ace file"
	@echo "*********************************************"
	xmd -tcl genace.tcl -jprog -hw $(DOWNLOAD_BIT) -elf $(TESTAPP_MEMORY_OUTPUT) $(BLINKER_OUTPUT)  -target ppc_hw  -ace $(SYSTEM_ACE)
